...
export default function Download(): ReactElement {
  const downloadLinkClasses = 'text-lg font-semibold mr-4';
    ...
    <Layout title="Download - Session Private Messenger">
      <section>
        ...
        >
          ...
          <div className={classNames('px-28 mb-6', 'md:px-10', 'lg:hidden')}>
            <Image
          ...
          >
            ...
            <Link href="/iphone">
              <a className={downloadLinkClasses}>
                <AppleSVG
                  className={classNames(downloadSVGClasses, 'w-4 h-4')}
                  title="Apple logo"
                />
                <span>iPhone</span>
              </a>
        ...
        >
          ...
          <div className={classNames('px-3 mb-6', 'md:px-10', 'lg:hidden')}>
            <Image
          ...
          >
            ...
            <Link href="/linux">
              <a className={downloadLinkClasses}>
                <LinuxSVG
                  className={classNames(downloadSVGClasses, 'w-5 h-5')}
                  title="Linux logo"
                />
                <span>Linux</span>
              </a>
